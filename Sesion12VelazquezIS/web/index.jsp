<%-- 
    Document   : index
    Created on : 30 oct. 2025, 08:10:43
    Author     : Nobara
--%>

<html>
    <head>
        <title>Pagina Principal Velazquez Aplicacion Web</title>
        <meta charset="UTF-8">
    ...
    <body>
        ...
        <div class="container">
            <center>
                ...
                <h4>LISTA OFICIAL DE USARIOS DE SISTEMA VELAZQUEZ</h4>
                <br>
            </center>  
            <%@include file="conexion.jsp"%><!--Llamada a la conexion de base de datos-->
